...
import { mailChimpSubscribeTrigger } from './lib/triggers/new-subscriber';
import { mailChimpNewUnsubscriberTrigger } from './lib/triggers/new-unsubscriber';
...
export const mailchimp = createPiece({
  ...
  triggers: [mailChimpSubscribeTrigger, mailChimpNewUnsubscriberTrigger],
});
